...
echo "|- let x = 1 in x + 2 : int" | cargo run -- prover --game TypingML2
echo "|- let f = fun x -> x + 1 in f 2 : int" | cargo run -- prover --game TypingML3
