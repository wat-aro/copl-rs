...
The current targets are checkers for the `Nat`, `CompareNat1`, `CompareNat2`, `CompareNat3`, `EvalML1`, `EvalNatExp`, and `ReduceNatExp` games.
...
- Implemented:
  ...
  - Supported `--game` values: `Nat`, `CompareNat1`, `CompareNat2`, `CompareNat3`, `EvalML1`, `EvalNatExp`, `ReduceNatExp` (lowercase forms are also accepted for backward compatibility)
